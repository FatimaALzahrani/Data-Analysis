...
<ol>
  ...
  <span class="o">*</span>
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
</code></pre></div>      </div>
    </details>
  </li>
  <li>
    ...
    <details>
      ...
      <p>‘<em>journey_id’ appears to be the primary key since it is the unique identifier of a campaign and the table has one row per campaign.</em>
<em>To verify that it is indeed a primary key, we can count distinct ‘journey_id’ values and compare the number with the total number of rows.</em></p>
      <div class="language-sql highlighter-rouge"><div class="highlight github"><pre class="highlight github"><code><span class="k">SELECT</span> <span class="k">DISTINCT</span> <span class="n">journey_id</span>
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
</code></pre></div>      </div>
      <p><em>We obtain 146 distinct ‘journey_id’ values and they are 146 rows in the table. There are no duplicates. ‘journey_id’ is the primary key.</em></p>
...
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
<span class="k">ORDER</span> <span class="k">BY</span> <span class="n">sent_nb</span> <span class="k">DESC</span>
</code></pre></div>      </div>
    </details>
  </li>
  <li>
    ...
    <details>
      ...
      <div class="language-sql highlighter-rouge"><div class="highlight github"><pre class="highlight github"><code><span class="k">SELECT</span> <span class="k">DISTINCT</span><span class="p">(</span><span class="n">journey_name</span><span class="p">)</span>
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
</code></pre></div>      </div>
    </details>
  </li>
  ...
  <span class="p">,</span><span class="n">journey_name</span> 
  <span class="p">,</span><span class="n">sent_nb</span>
  <span class="p">,</span><span class="n">opening_nb</span>
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
<span class="k">WHERE</span>  <span class="n">opening_nb</span> <span class="o">&gt;=</span> <span class="mi">10000</span>
<span class="k">ORDER</span> <span class="k">BY</span> <span class="n">opening_nb</span> <span class="k">DESC</span>
</code></pre></div>      </div>
    </details>
  </li>
  <li>
  ...
  <span class="p">,</span><span class="n">sent_nb</span>
  <span class="p">,</span><span class="n">opening_nb</span>
  <span class="p">,</span><span class="n">click_nb</span>
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
<span class="k">ORDER</span> <span class="k">BY</span> <span class="n">click_nb</span> <span class="k">DESC</span>
...
<span class="k">WHERE</span>
  <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="nv">"210707_nl_happyhour%"</span>
</code></pre></div>      </div>
    </details>
  </li>
  <li>
   ...
   <span class="p">,</span><span class="n">click_nb</span>
 <span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
 <span class="k">WHERE</span> <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="nv">"%nlbe%"</span>
 <span class="k">ORDER</span> <span class="k">BY</span> 
   <span class="n">sent_nb</span> <span class="k">DESC</span>
</code></pre></div>      </div>
    </details>

    <h2 id="2---data-exploration-for-crm-team">2 - Data Exploration for CRM Team</h2>
  ...
  <li>
    ...
    <details>
      ...
      <p><em>There are 67 campaigns returned</em></p>

      <p><u>_Note_</u><em>-</em> <code>“_”</code> is a special typeface for the <code>LIKE</code> clause that represents a single character. So if you only use <em><code>journey_name LIKE "%_nl_%"</code></em> in your <code>WHERE</code> clause, you will also include rows with <code>_nlbe_</code> in the journey_name.</p>
      <div class="language-sql highlighter-rouge"><div class="highlight github"><pre class="highlight github"><code><span class="k">SELECT</span> 
  <span class="o">###</span> <span class="k">Key</span> <span class="o">###</span>
  <span class="n">journey_id</span>
  <span class="o">###########</span>
...
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
<span class="k">WHERE</span> <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="nv">"%nl%"</span> 
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">NOT</span> <span class="k">LIKE</span> <span class="nv">"%nlbe%"</span>
<span class="k">ORDER</span> <span class="k">BY</span>
  <span class="n">sent_nb</span> <span class="k">DESC</span>
</code></pre></div>      </div>
    </details>
  ...
  <li>
    ...
    <ul>
      <li>
        <p>You can use ROUND() to display 1 or 2 digits after the number.</p>
      </li>
      <li>
        <p>Don’t forget that these KPIs should only be calculated for the newsletters from France and not all the campaigns!</p>
      </li>
  ...
  <span class="p">,</span><span class="n">click_nb</span>
  <span class="p">,</span><span class="n">turnover</span>
  <span class="p">,</span><span class="n">ROUND</span><span class="p">(</span><span class="n">opening_nb</span><span class="o">/</span><span class="n">sent_nb</span><span class="o">*</span><span class="mi">100</span><span class="p">,</span><span class="mi">1</span><span class="p">)</span> <span class="k">AS</span> <span class="n">opening_rate</span>
  <span class="p">,</span><span class="n">ROUND</span><span class="p">(</span><span class="n">click_nb</span><span class="o">/</span><span class="n">sent_nb</span><span class="o">*</span><span class="mi">100</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span> <span class="k">AS</span> <span class="n">click_rate</span>
  <span class="p">,</span><span class="n">ROUND</span><span class="p">(</span><span class="n">click_nb</span><span class="o">/</span><span class="n">opening_nb</span><span class="o">*</span><span class="mi">100</span><span class="p">,</span><span class="mi">1</span><span class="p">)</span> <span class="k">AS</span> <span class="n">CTR</span>
  <span class="p">,</span><span class="n">ROUND</span><span class="p">(</span><span class="n">turnover</span><span class="o">/</span><span class="n">sent_nb</span><span class="o">*</span><span class="mi">1000</span><span class="p">,</span><span class="mi">1</span><span class="p">)</span> <span class="k">AS</span> <span class="n">turnover_per_mille</span>
<span class="k">FROM</span> <span class="nv">`course14.gwz_mail`</span>
<span class="k">WHERE</span> <span class="k">TRUE</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="nv">"%_nl_%"</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">NOT</span> <span class="k">LIKE</span> <span class="nv">"%nlbe%"</span>
<span class="k">ORDER</span> <span class="k">BY</span>
  <span class="n">sent_nb</span> <span class="k">DESC</span>
</code></pre></div>      </div>
  ...
  <li>
    ...
    <details>
      ...
      <p>_<strong>210707_nl_happyhour_12h</strong>__has much better opening statistics. A 3% difference in the opening rate. The CTR is the same though, so the overall click_rate is even better with the nl_happyhour_12h .</p>

      <p>However, the turnover_per_mille (turnover_per_thousand) is better for the_ <em><strong>210707_nl_happyhour.</strong></em> <em>Maybe</em> <em><strong>210707_nl_happyhour</strong></em> <em>customers were less interested in clicking in the morning, but they had more time to prepare their cart during the day in order to validate it in the evening.</em></p>

      <p><em><strong>210707_nl_happyhour_12h</strong>__customers were more available and interested in clicking but they had less time to prepare their order for the night.</em></p>
...
<span class="k">WHERE</span> <span class="k">TRUE</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="nv">"%_nl_%"</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">NOT</span> <span class="k">LIKE</span> <span class="nv">"%nlbe%"</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="s1">'%happyhour%'</span>
<span class="k">ORDER</span> <span class="k">BY</span>
  <span class="n">sent_nb</span> <span class="k">DESC</span>
</code></pre></div>      </div>
    </details>

    <h3 id="bonus"><u>Bonus</u></h3>
  </li>
  <li>
    <p>Add a new <code>date_date</code> column to the query from step 9 by extracting the campaign date from the <code>journey_name</code> column. Finally, order the results by ascending date.</p>
    ...
    <ul>
      <li>
        <p><em>You can use SUBSTR(), CAST() AND potentially CONCAT().</em></p>
      </li>
      <li>
        <p><em>You can exclude rows that do not start with a number.</em></p>
      </li>
  ...
  <span class="n">journey_id</span>
  <span class="o">###########</span>
 <span class="p">,</span><span class="nb">DATE</span><span class="p">(</span><span class="k">CAST</span><span class="p">(</span><span class="n">CONCAT</span><span class="p">(</span><span class="s1">'20'</span><span class="p">,</span><span class="n">SUBSTR</span><span class="p">(</span><span class="n">journey_name</span><span class="p">,</span><span class="mi">1</span><span class="p">,</span><span class="mi">2</span><span class="p">))</span> <span class="k">AS</span> <span class="n">INT64</span><span class="p">),</span><span class="k">CAST</span><span class="p">(</span><span class="n">SUBSTR</span><span class="p">(</span><span class="n">journey_name</span><span class="p">,</span><span class="mi">3</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span> <span class="k">AS</span> <span class="n">INT64</span><span class="p">),</span><span class="k">CAST</span><span class="p">(</span><span class="n">SUBSTR</span> <span class="p">(</span><span class="n">journey_name</span><span class="p">,</span><span class="mi">5</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span> <span class="k">AS</span> <span class="n">INT64</span><span class="p">))</span> <span class="k">AS</span> <span class="n">date_date</span>
  <span class="p">,</span><span class="n">journey_name</span> 
  <span class="p">,</span><span class="n">sent_nb</span>
  <span class="p">,</span><span class="n">opening_nb</span>
  <span class="p">,</span><span class="n">click_nb</span>
...
<span class="k">WHERE</span> <span class="k">TRUE</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">LIKE</span> <span class="nv">"%_nl_%"</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">NOT</span> <span class="k">LIKE</span> <span class="nv">"%nlbe%"</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">NOT</span> <span class="k">LIKE</span> <span class="nv">"COPY%"</span>
  <span class="k">AND</span> <span class="n">journey_name</span> <span class="k">NOT</span> <span class="k">LIKE</span> <span class="nv">"2108_nl_marketplace_1"</span>
<span class="k">ORDER</span> <span class="k">BY</span>
